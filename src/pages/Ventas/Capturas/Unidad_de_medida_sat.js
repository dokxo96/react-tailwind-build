...
import Input from "@material-tailwind/react/Input";
 ...
 import { borrar,añadir,editar,buscar } from "services/APIUnidaddemedida";

 import {baseURL} from 'services/API'

export default function Unidad_de_medida_sat() {
 ...
 const lista=["/unidad_de_medida/getall","/unidad_de_medida/getalla"];
 //Modifies
  const Changedescr = (e) => {
    console.log(desc);
...
return;
  ...
  function get(id) {
    try {
      axios.get(baseURL+'unidad_de_medida/findbyid?id='+id)
      .then((res) => {
   ...
   {   <Modal
      ...
      >
        <ModalHeader toggler={() => setShowModal(false)}>
          Agregar un nueva unidad_de_medida  
        </ModalHeader>
        ...
        <ModalBody>
            ...
            <CardBody>
              <div className="mb-6">
              <Input type="text" color="lightBlue"size="sm"  onChange={Changecodigo} maxlength="3"outline={false}  placeholder="Codigo"   />
              </div>
              <div  className="mt-4" >
              <Textarea
            color="lightBlue"
   ...
   {   <Modal
      ...
      >
        ...
        <ModalBody>
            ...
            <CardBody>
            <div className="mb-6">
              <Input type="text" color="lightBlue"size="sm"  onChange={Changecodigo} maxlength="3" value={codigostate} outline={false}  placeholder="Codigo"   />
              </div>
              <div className="    ">
              <Textarea
            color="lightBlue"
