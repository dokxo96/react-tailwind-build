...
export default function Header() {
    return (
        <div className="relative bg-gray-100 pt-16 pb-32 flex content-center items-center justify-center h-screen">
            <div className=" bg-black
             bg-cover bg-center absolute top-0 w-full h-full" />
